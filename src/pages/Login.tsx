    ...
    <div className="min-h-screen bg-[#FFF5F7]/30 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          <Link to="/" className="inline-flex flex-col items-center gap-3 mb-8 group">
            <div className="w-24 h-24 bg-white rounded-3xl shadow-2xl flex items-center justify-center border border-zinc-50 group-hover:rotate-12 transition-all duration-500">
              <img src="/bedzzz-logo.png" alt="Bedzzz Logo" className="w-16 h-16 object-contain" />
            </div>
            <span className="text-zinc-900 font-black text-5xl tracking-tighter uppercase italic">Bed<span className="text-primary italic-none">zzz</span></span>
          </Link>
          <h1 className="text-4xl font-black text-zinc-900 uppercase tracking-tighter italic">Welcome Home</h1>
          <p className="text-zinc-500 mt-3 font-medium italic">Return to your personal sanctuary of comfort.</p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between mx-4">
                 ...
                 <a href="#" className="text-[10px] text-primary font-black uppercase tracking-widest hover:underline shadow-sm">Forgot?</a>
              </div>
              <Input
                placeholder="••••••••"
                type="password"
            ...
            <Button type="submit" className="w-full h-16 gap-3 rounded-[1.5rem] shadow-2xl shadow-primary/30 font-black uppercase tracking-[0.2em]" isLoading={mutation.isPending}>
        ...
        <p className="text-center mt-10 text-zinc-400 font-bold italic">
          New to the family?{' '}
          <Link to="/signup" className="text-primary font-black hover:underline tracking-tight not-italic ml-1">
            Create an account
          </Link>
        </p>
      </motion.div>
